...
export const TUTORIAL_STEPS: readonly TutorialStep[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Passo 4 — Na confirmação, a baixa no estoque do Omie acontece sozinha, item por item, e a situação de cada item fica visível no pedido.",
    ],
    icon: "requisicoes",
  ...
  },
  {
    ...
    body: [
      ...
      "Passo 3 — O sistema confere cada linha no Omie (código existe? tem saldo?) SEM baixar nada ainda — você revisa antes.",
      "Passo 4 — Ao executar, a saída é lançada no estoque do Omie item a item; se interromper no meio, dá para continuar de onde parou sem baixar duas vezes.",
    ],
    icon: "baixas",
